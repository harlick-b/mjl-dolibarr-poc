...
class MjlExpense extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_budget_line' => array('type' => 'integer:MjlBudgetLine:mjlfinancement/class/mjlbudgetline.class.php:1', 'label' => 'MJLBudgetLine', 'enabled' => 1, 'position' => 40, 'notnull' => 1, 'visible' => 1, 'index' => 1, 'validate' => 1),
		'fk_expensereport' => array('type' => 'integer:ExpenseReport:expensereport/class/expensereport.class.php:1', 'label' => 'ExpenseReport', 'enabled' => 'isModEnabled("expensereport")', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'validate' => 1),
		'amount' => array('type' => 'price', 'label' => 'Amount', 'enabled' => 1, 'position' => 60, 'notnull' => 1, 'visible' => 1, 'isameasure' => 1, 'validate' => 1),
		'expense_date' => array('type' => 'date', 'label' => 'Date', 'enabled' => 1, 'position' => 70, 'notnull' => -1, 'visible' => 1, 'validate' => 1),
		...
		'status' => array('type' => 'integer', 'label' => 'Status', 'enabled' => 1, 'position' => 2000, 'notnull' => 1, 'visible' => 1, 'index' => 1, 'default' => '0', 'arrayofkeyval' => array(0 => 'Draft', 1 => 'Validated', 2 => 'Paid', 8 => 'Rejected', 9 => 'Canceled'), 'validate' => 1),
	);
	...
	public function validate(User $user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_VALIDATED, $notrigger, 'MJLFINANCEMENT_EXPENSE_VALIDATE');
	}
