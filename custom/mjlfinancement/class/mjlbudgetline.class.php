...
class MjlBudgetLine extends CommonObject
{
	...
	public $fields = array(
		...
		'amount_planned' => array('type' => 'price', 'label' => 'MJLAmountPlanned', 'enabled' => 1, 'position' => 60, 'notnull' => 0, 'visible' => 1, 'isameasure' => 1, 'validate' => 1),
		'amount_committed' => array('type' => 'price', 'label' => 'MJLAmountCommitted', 'enabled' => 1, 'position' => 70, 'notnull' => 0, 'visible' => 1, 'isameasure' => 1, 'validate' => 1),
	...
	public $fk_project;
	public $amount_planned;
	public $amount_committed;
	public $status;
	public $note_public;
	public $note_private;
