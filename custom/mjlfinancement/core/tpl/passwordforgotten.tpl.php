...
top_htmlhead('', 'Mot de passe oublié', 0, 0, array(), array('/custom/mjlfinancement/css/mjl_auth.css.php'), 1, 1);
?>
...
<main class="mjl-auth-panel" aria-labelledby="mjl-forgot-title">
	<div class="mjl-auth-brand">
		<h1 id="mjl-forgot-title">Mot de passe oublié</h1>
		<p>Indiquez l’adresse e-mail associée à votre accès MJL.</p>
	</div>
	...
	<form id="mjl-password-request" method="post" action="<?php print $php_self; ?>">
		...
		<div class="mjl-auth-actions">
			<button type="submit" class="mjl-auth-button">Réinitialiser le mot de passe</button>
