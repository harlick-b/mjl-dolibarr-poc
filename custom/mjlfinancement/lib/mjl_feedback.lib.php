...
function mjl_feedback_registry()
{
	return array(
		...
		'activity.created' => mjl_feedback_definition('Activité créée en brouillon.', 'success'),
		'activity.comment_added' => mjl_feedback_definition('Commentaire ajouté à l’activité.', 'success'),
		'activity.saved' => mjl_feedback_definition('Action sur l’activité enregistrée.', 'success'),
		'expense.created' => mjl_feedback_definition('Dépense créée en brouillon.', 'success'),
		'expense.comment_added' => mjl_feedback_definition('Commentaire ajouté à la dépense.', 'success'),
		'expense.saved' => mjl_feedback_definition('Action sur la dépense enregistrée.', 'success'),
		'convention.created' => mjl_feedback_definition('Enveloppe de financement créée en brouillon.', 'success'),
		'convention.saved' => mjl_feedback_definition('Action sur l’enveloppe de financement enregistrée.', 'success'),
		'budget_line.created' => mjl_feedback_definition('Ligne budgétaire créée en brouillon.', 'success'),
		'budget_line.saved' => mjl_feedback_definition('Action sur la ligne budgétaire enregistrée.', 'success'),
		'fund_receipt.created' => mjl_feedback_definition('Réception de fonds créée en brouillon.', 'success'),
		'fund_receipt.saved' => mjl_feedback_definition('Action sur la réception de fonds enregistrée.', 'success'),
