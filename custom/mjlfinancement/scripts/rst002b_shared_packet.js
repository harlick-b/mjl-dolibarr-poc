...
function parseArguments(argv) {
  ...
  invariant(values.profile === undefined || values.profile === 'disposable-shared-shape','Packet profile is invalid.'); return values;
}
function main() {
