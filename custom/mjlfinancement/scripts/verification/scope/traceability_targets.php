...
$marker = 'TRACEABILITY-INTEGRITY-'.bin2hex(random_bytes(4));
$db->begin();
...
$sql .= " VALUES (".$entity.", '".$db->escape($marker)."', 'Traceability integrity verification', 'Audit', 'CSV/XLSX', '', '', NOW(), 1, 'TRCINT')";
