...
function validateApproval(value, mode) {
  ...
  if(value.failure_point!==undefined) invariant(value.target_profile==='disposable_shared_shape'&&/^(?:every-(?:forward|rollback)-prefix-and-report|forward-(?:0[1-5]-(?:assignment-table-created|activity-old-guard-dropped|activity-column-cutover|activity-target-guard-created|scope-table-removed)|trigger-0[1-7])|rollback-(?:trigger-0[1-7]|scope-table-restored|activity-target-guard-dropped|activity-column-restored|activity-old-guard-restored|assignment-table-dropped))$/.test(value.failure_point),'Failure injection is restricted to the disposable shared-shape profile.');
