...
ALTER TABLE llx_mjlfinancement_activity ADD INDEX idx_mjlfinancement_activity_fk_user_responsible (fk_user_responsible);
...
ALTER TABLE llx_mjlfinancement_activity ADD CONSTRAINT fk_mjlfinancement_activity_responsible FOREIGN KEY (fk_user_responsible) REFERENCES llx_user(rowid);
