...
-- llx_mjl_activity_rst005_bi is installed as one driver statement by activity_schema_installer.lib.php.
CREATE TRIGGER llx_mjl_activity_rst005_bu BEFORE UPDATE ON llx_mjlfinancement_activity FOR EACH ROW SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'MJL Activity mutation is dormant in RST-005';
