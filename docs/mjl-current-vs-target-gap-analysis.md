...
| Dashboards, browsing and navigation | Financial-first Accueil, computed alerts, scoped browsing, permitted-action queues and Alertes/Rapports/exception navigation are implemented behind exact RST-012 readiness. Shared Phase 3A retains its predecessor surfaces. | Focused dashboard slice: 79/79 passed. Aggregate validation: 211 Node and 192 browser tests passed, including scale/performance and schema/renderer probes; shared-state evidence matched and teardown completed. Expanded failure/recovery, race, discovery and disposable cutover proofs, human accessibility and guarded shared cutover remain pending. See `docs/mjl-phase-3b-validation-2026-09-10.md`. |
