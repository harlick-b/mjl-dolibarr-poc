...
Review and explicitly approve RST-001 before implementing the effective-role
and native-admin invariant. Neither RST-000A approval nor its supplemental
ratification approves RST-001.
