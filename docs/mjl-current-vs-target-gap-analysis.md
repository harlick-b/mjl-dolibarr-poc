...
| No self-review | Activity and expense workflow code contains no-self checks; current workflow E2E and both smoke scripts passed during Phase 2 verification. | IMPLEMENTED_VERIFIED_LOCAL | Tenant-specific final permissions still require production confirmation. | Keep no-self direct-POST tests in every workflow regression gate. | `custom/mjlfinancement/class/mjlactivity.class.php`, `custom/mjlfinancement/class/mjlexpense.class.php`, `tests/e2e/phase7-activity-workflow.spec.js`, `tests/e2e/phase11-expense-workflow.spec.js` |
