...
| Dashboards, browsing and navigation | Financial-first Accueil, computed alerts, scoped browsing, permitted-action queues and Alertes/Rapports/exception navigation are implemented behind exact RST-012 readiness. Shared Phase 3A retains its predecessor surfaces. | Focused dashboard slice: 79/79 combined E2E checks passed; shared-state evidence unchanged and disposable teardown verified. Whole-phase validation, human accessibility and guarded cutover remain pending. |
