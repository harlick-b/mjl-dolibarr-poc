...
| --- | --- | --- | --- | --- |
| Workspace dashboard | `/custom/mjlfinancement/index.php` | Role-aware cards, metrics, quick links, and alerts context. | Any user who can enter the MJL workspace. | Some legacy supervision wording remains. |
...
| Supervision dashboard | `/custom/mjlfinancement/dpafdashboard.php` | Portfolio supervision metrics and pending reviews. | Supervision access. | Route/labels still use DPAF. |
| Reports / exports | `/custom/mjlfinancement/reports.php` | Fixed reports, previews, CSV/XLSX export. | Supervision; export requires export write/Admin. | Final templates and export audit pending. |
