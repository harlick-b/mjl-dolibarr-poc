...
| Activities | Medium | Dedicated guarded create/edit states, shared scoped filters/pagination, responsive list cards, and verifier/final-validator decision states are browser-verified; execution, submission/correction, document upload, and wording review remain. | `custom/mjlfinancement/activities.php` |
| Expenses | Medium | Shared scoped filters/pagination, responsive operational cards, and dedicated guarded prevalidation/final-validation/rejection/disbursement states are browser-verified; creation, edit, submission/correction, document upload, and wording review remain. | `custom/mjlfinancement/expenses.php` |
