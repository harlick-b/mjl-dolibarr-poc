...
| Activities | Medium | Shared scoped filters/pagination, responsive list cards, and dedicated guarded verifier/final-validator decision states are browser-verified; edit, execution, submission/correction, document upload, and wording review remain. | `custom/mjlfinancement/activities.php` |
