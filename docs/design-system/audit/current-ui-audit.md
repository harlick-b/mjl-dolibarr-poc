...
| Activities | Medium | Dedicated guarded create/edit, contextual-upload, and verifier/final-validator decision states plus shared scoped filters/pagination and responsive list cards are browser-verified; execution, submission/correction, and wording review remain. | `custom/mjlfinancement/activities.php` |
| Expenses | Medium | Shared scoped filters/pagination, responsive operational cards, and dedicated guarded contextual-upload/prevalidation/final-validation/rejection/disbursement states are browser-verified; creation, edit, submission/correction, and wording review remain. | `custom/mjlfinancement/expenses.php` |
