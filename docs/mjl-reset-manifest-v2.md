...
- Exact paths: `custom/mjlfinancement/index.php`, `custom/mjlfinancement/alerts.php`, `custom/mjlfinancement/class/mjlmonitoring.class.php`, `custom/mjlfinancement/lib/mjl_monitoring.lib.php`, `custom/mjlfinancement/lib/mjl_monitoring_route.lib.php`, `custom/mjlfinancement/lib/mjl_monitoring_access.lib.php`, `custom/mjlfinancement/lib/mjl_monitoring_work.lib.php`, `custom/mjlfinancement/lib/mjl_activity_route.lib.php`, `custom/mjlfinancement/lib/mjl_operation_route.lib.php`, `custom/mjlfinancement/lib/mjl_operation_request_route.lib.php`, `custom/mjlfinancement/lib/mjl_timeline_presentation.lib.php`, `tests/unit/phase3b-monitoring.test.js`, `tests/e2e/phase3b-monitoring.spec.js`.
