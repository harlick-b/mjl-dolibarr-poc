...
| `docs/mjl-rst-002b-activity-assignment-strategy.md` | Approved-at-`7676f1f` RST-002B implementation boundary and corrected inventory; implementation in progress and no shared execution authorized |
