...
| `docs/mjl-phase-2-readiness-report.md` | Active Phase 2 evidence and blocked-pending-human-accessibility verdict |
...
| `docs/mjl-rst-002b-activity-assignment-strategy.md` | Executed RST-002B boundary plus DEC-049 simple fast local-cutover rule |
| `docs/mjl-rst-002b-execution-report.md` | Active RST-002B local cutover, diagnostic correction, and verification evidence; not target-rule authority |
...
| `docs/mjl-rst-005-execution-report.md` | Active shared RST-005 execution, backup/restore, immutable-chain, before/after, independent verification, and zero-survivor evidence; not target-rule authority |
